...
//  设置toast位置
  static _calToastPosition(context) {
    ...
    if(_toastPosition == 'top'){
      ...
      backResult = MediaQuery.of(context).size.height * 0.5;
    }else{
...
//  调用发法
            ...
            //   bgColor: ThemeColors.blackFontColor,        // Color 提示框背景颜色
            //   textColor: ThemeColors.lightGrayColor,  // Color 提示框文字颜色
            //   textSize: 18.0,                               // double 提示框文字大小
            //   position: 'bottom',                           // String 提示框显示位置，默认是center，可设置top和bottom
            //   pdHorizontal: 50.0,                           // double 左右边距
            //   pdVertical: 10.0,                             // double 上下边距
            // );