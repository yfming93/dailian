...
class CaptchaInputWidget extends StatefulWidget {
  CaptchaInputWidget(
      {this.count = 6,
        this.itemWidget = 45,
        this.onSubmitted,
        this.type = CaptchaBoxItemType.box,
        this.decoration,
  ...
  ///
  /// 每个item的装饰类型，[CaptchaBoxItemType]
  ///
  final CaptchaBoxItemType type;
  ...
  @override
  State<StatefulWidget> createState() => _CaptchaInputWidget();
}

class _CaptchaInputWidget extends State<CaptchaInputWidget> {
